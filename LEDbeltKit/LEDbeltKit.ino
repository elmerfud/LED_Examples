...
void loop() {
  ...
  colorWipe(Color(127,0,0), 20);      // red
  colorWipe(Color(0, 127,0), 20);     // green
  colorWipe(Color(0,0,127), 20);      // blue
  colorWipe(Color(0,0,0), 20);        // black
  ...
  // Wavy ripple effects
  wave(Color(127,0,0), 4, 20);        // candy cane
  wave(Color(0,0,100), 2, 40);        // icy
